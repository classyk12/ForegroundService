...
namespace ForegroundService.AllConstants
{
   public class MPConstants
    {
        public static string CHANNEL_NAME = "MY_CHANNEL";

        public static string CHANNEL_ID1 = "MY_CHANNEL_ID";

        public static string CHANNEL_ID2 = "MY_CHANNEL_ID2";
